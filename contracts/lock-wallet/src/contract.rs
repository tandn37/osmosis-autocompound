...
pub mod execute {
    ...
    pub fn add_liquidity(
        owner: String, pool_id: u64, amount: String, denom: String, min_shares: String,
    ) -> Result<Response, ContractError> {
...
pub mod reply {
    ...
    pub fn handle_add_liquidity(deps: DepsMut, env: Env, msg: Reply) -> Result<Response, ContractError> {
